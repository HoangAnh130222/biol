...
window.SPAWNING = [
  ...
  { id: 'webmeji-3', config: 'PAIMON_CONFIG' },
];
...
window.PAIMON_CONFIG = {
  ...
  gettingupspeed: 3500,
  walk: {
    frames: ["paimon/shime1.png", "paimon/shime2.png", "paimon/shime3.png", "paimon/shime2.png"],
    interval: 175, loops: 6
  },
  stand: { frames: ["paimon/shime1.png"], interval: 1000, loops: 1 },
  sit: { frames: ["paimon/shime11.png"], interval: 1000, loops: 1, randomizeDuration: true, min: 3000, max: 11000 },
  spin: { frames: ["paimon/shime1.png"], interval: 150, loops: 3 },
  dance: { frames: ["paimon/shime5.png", "paimon/shime6.png", "paimon/shime1.png"], interval: 200, loops: 2 },
  trip: { frames: ["paimon/shime18.png", "paimon/shime19.png", "paimon/shime19.png"], interval: 250, loops: 1 },
  forcewalk: { loops: 6 },
  forcethink: { frames: ["paimon/shime27.png", "paimon/shime28.png"], interval: 500, loops: 2 },
  pet: { frames: ["paimon/shime15.png", "paimon/shime16.png", "paimon/shime17.png"], interval: 400 },
  drag: { frames: ["paimon/shime7.png", "paimon/shime5.png", "paimon/shime8.png", "paimon/shime6.png"], interval: 210 },
  falling: { frames: ["paimon/shime10.png", "paimon/shime18.png"], interval: 200, loops: 2 },
  fallen: { frames: ["paimon/shime9.png", "paimon/shime4.png", "paimon/shime19.png"], interval: 250, loops: 1 },
  ORIGINAL_ACTIONS: [ 'walk','walk','walk','walk','walk','walk', 'spin','spin','spin', 'sit','sit', 'dance','dance','dance','dance','dance', 'trip' ],
  EDGE_ACTIONS: [ 'hang','hang', 'climb','climb','climb','climb','climb', 'fall' ],
  JUMP_CHANCE: 0.1,
  climbSide: { frames: ["paimon/shime13.png", "paimon/shime14.png"], interval: 200, loops: 2 },
  hangstillSide: { frames: ["paimon/shime12.png"], interval: 200, loops: 2, randomizeDuration: true, min: 3000, max: 11000 },
  climbTop: { frames: ["paimon/shime24.png", "paimon/shime25.png"], interval: 200, loops: 8 },
  hangstillTop: { frames: ["paimon/shime23.png"], interval: 200, loops: 2, randomizeDuration: true, min: 3000, max: 11000 },
  jump: { frames: ["paimon/shime22.png"], interval: 200 }
};
